...
WarpTileUpdateComponent::WarpTileUpdateComponent(Ov_Sprite::RunSprite* player, World::Tile loc, World::WorldHeight height, World::LevelID currentLevel, World::Tile dest, World::WorldHeight destHeight, World::LevelID levelDest)
{
...
void WarpTileUpdateComponent::changeLevel()
{
	...
	Position<SGRender::NTVertex>(&m_PlayerPointer->m_Sprite, { m_PlayerPointer->m_XPos - World::TILE_SIZE / 2, m_PlayerPointer->m_YPos, m_PlayerPointer->m_ZPos }, { newXPos - World::TILE_SIZE / 2, newYpos, newZPos }, Shape::QUAD);
