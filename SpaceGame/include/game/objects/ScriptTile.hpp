...
class ScriptTile : public SGObject::GObject {};
...
{
public:
	ScriptTileUpdateComponent(Ov_Sprite::RunSprite* player, World::Tile loc, World::WorldHeight height, World::LevelID id) { m_PlayerPointer = player; m_TileLocation = loc; m_CurrentHeight = height; m_LevelCurrent = id; };
