...
{
public:
	ScriptTileUpdateComponent(OvSpr_RunningSprite* player, World::TileLoc loc, World::WorldHeight height, World::LevelID id) { m_PlayerPointer = player; m_TileLocation = loc; m_CurrentHeight = height; m_LevelCurrent = id; };
