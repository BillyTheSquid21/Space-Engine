...
{
	//Core
	NO_OP, BLANK_OP, SET_FLAG, JMP, JMP_IF, WAIT_SEC, PLAYER_LOCK, PLAYER_FACE, PLAYER_WALK, PLAYER_RUN, 
	OPEN_MSG_BOX, CLOSE_MSG_BOX, MSG, CLEAR_TEXT, GIVE_ITEM, TAKE_ITEM, WAIT_INPUT, WAIT_FOR,
	WARP_PLAYER, SET_PLAYER_TILE, PLAYER_WALK_TO_TILE, PLAYER_RUN_TO_TILE, HEAL_PARTY,

	CORE_MAX, //max to give return term - TODO define each exactly so can guarantee CORE_MAX is bigger
	
	//NPC aimed
	FREEZE_OBJECT, FACE_PLAYER, FACE_WITH_PLAYER, NPC_FACE, NPC_WALK, NPC_RUN, WAIT_INTERACT, 
	NPC_AND_PLAYER_WALK, SHOW_SPRITE, NPC_WALK_TO_TILE, NPC_RUN_TO_TILE,
};
