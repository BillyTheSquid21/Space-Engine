...
namespace ScriptParse
{
	...
	inline static void PSS_LOCK_PLAYER(std::string(&instrArr)[MAX_INFO], ScriptElement& element);
	...
	inline static void PSS_SET_BUSY(std::string(&instrArr)[MAX_INFO], ScriptElement& element);
}
